        ...
        <bottom   data-aos="flip-right"
                ...
                <div className='block2'>
                    <div className='infoProject'>
                       ...
                       1. Time&Material
                        <li> Проект разбивается на задачи, каждую из которых команда оценивает отдельно,
                            так что у вас есть возможность вносить любые дополнения в ходе работ.
                            Когда задача выполнена и вам предоставлен видимый результат — вы оплачиваете
                            работу команды (оплата может происходить сразу после спринта, ежемесячно, раз в
                            квартал и т.д. — как вам удобно). Эта модель идеально подходит для реализации MVP
                            или проектов, которые могут поменяться в зависимости от специфики рынка. Релиз и
                            тестирование проекта происходит по окончании каждого этапа.</li>
                        <br/>
                        ...
                        <li>Стоимость проекта меняется как в большую, так и в меньшую сторону по мере
                            внесения изменений в план реализации</li>
